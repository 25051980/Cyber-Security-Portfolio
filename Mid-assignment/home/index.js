...
// Main update function, called on filter/sort change// Main update function, called on filter/sort change
async function updateProductList() {
  const allProducts = await loadProducts(); // ✅ Await the async function
